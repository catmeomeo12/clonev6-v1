                        ...
                        <div class="card p-3">
                            <div class="card-body">
                                ...
                                <!-- <p class="text-center text-secondary mb-4">
                                    <?=__('Đăng nhập vào tài khoản của bạn để tiếp tục');?></p>
                                ...
                                <form>
                                    ...
                                    <div class="col-lg-12 mt-3">
                                        <p class="mb-0 text-center"><?=__('Nếu bạn không có tài khoản, thì bạn hãy bấm ');?> <a
                                                href="<?=base_url('client/register');?>"><?=__('Đăng ký');?></a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
