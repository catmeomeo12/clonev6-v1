                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="type">
                                        ...
                                        <option value="SHOPCLONE7">
                                            SHOPCLONE7 CMSNT
                                        </option>
                                        <?php if(checkAddon(11412) == false):?>
                                        <option value="API_1">
                                            API 1
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11413) == false):?>
                                        <option value="API_4">
                                            API 4
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11422) == false):?>
                                        <option value="DONGVANFB">
                                            DONGVANFB
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11427) == false):?>
                                        <option value="API_6">
                                            API 6
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11487) == false):?>
                                        <option value="API_7">
                                            API 7
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11535) == false):?>
                                        <option value="API_8">
                                            API 8
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11542) == false):?>
                                        <option value="API_9">
                                            API 9
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11635) == false):?>
                                        <option value="API_10">
                                            API 10
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11645) == false):?>
                                            <option value="API_11">
                                                API 11
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11657) == false):?>
                                            <option value="API_12">
                                                API 12
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11724) == false):?>
                                            <option value="API_13">
                                                API 13
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11735) == false):?>
                                            <option value="API_14">
                                                API 14
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11872) == false):?>
                                            <option value="API_15">
                                                API 15
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11898) == false):?>
                                            <option value="API_16">
                                                API 16
                                            </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11901) == false):?>
                                            <option value="API_17">
                                                API 17
                                            </option>
                                        <?php endif?>
                                ...
                                <p>Nếu bạn kết nối đến API SHOPCLONE7 của CMSNT, ô Password vui lòng nhập API KEY của website cần kết nối, ô Username nhập mã giảm giá nếu có, không có thì nhập đại username</p>
                            </div>
