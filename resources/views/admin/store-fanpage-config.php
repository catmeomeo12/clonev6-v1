...
$body = [
    'title' => 'Cấu hình bán Fanpage/Group',
    'desc'   => 'CMSNT Panel',
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Cấu hình bán Fanpage/Group</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=base_url_admin('home');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Cấu hình bán Fanpage/Group</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Status</label>
                                    <?php if(checkAddon(14232) == false):?>
                                    <select class="form-control select2bs4" name="status_store_fanpage">
                                        <option <?=$CMSNT->site('status_store_fanpage') == 1 ? 'selected' : '';?>
                                            value="1">ON
                                        </option>
                                        <option <?=$CMSNT->site('status_store_fanpage') == 0 ? 'selected' : '';?>
                                            value="0">
                                            OFF
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="notice_store_fanpage"
                                        name="notice_store_fanpage"><?=$CMSNT->site('notice_store_fanpage');?></textarea>
                                </div>
                            </div>
...
?>
<script>
CKEDITOR.replace("notice_store_fanpage");
</script>