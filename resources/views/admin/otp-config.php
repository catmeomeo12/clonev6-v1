        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mr-1 mb-3">
                                            <textarea class="form-control" rows="1" name="title_thuesim"
                                                required><?=$CMSNT->site('title_thuesim');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mr-1 mb-3">
                                            <textarea class="form-control" rows="1" name="description_thuesim"
                                                required><?=$CMSNT->site('description_thuesim');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mr-1 mb-3">
                                            <textarea class="form-control" rows="1" name="keyword_thuesim"
                                                required><?=$CMSNT->site('keyword_thuesim');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Domain API</label>
                                    <div class="row">
                                        <div class="col-lg-12 mr-1 mb-3">
                                            <textarea class="form-control" rows="1" name="domain_thuesim"
                                                required><?=$CMSNT->site('domain_thuesim');?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="server_thuesim">
                                        <?php if(checkAddon(11621) == false):?>
                                        <option
                                            <?=$CMSNT->site('server_thuesim') == 'API_1' ? 'selected' : '';?>
                                            value="API_1">API 1
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11634) == false):?>
                                        <option
                                            <?=$CMSNT->site('server_thuesim') == 'API_2' ? 'selected' : '';?>
                                            value="API_2">API 2
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11656) == false):?>
                                        <option
                                            <?=$CMSNT->site('server_thuesim') == 'API_3' ? 'selected' : '';?>
                                            value="API_3">API 3
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11678) == false):?>
                                        <option
                                            <?=$CMSNT->site('server_thuesim') == 'API_4' ? 'selected' : '';?>
                                            value="API_4">API 4
                                        </option>
                                        <?php endif?>
                                        <?php if(checkAddon(11698) == false):?>
                                        <option
                                            <?=$CMSNT->site('server_thuesim') == 'API_5' ? 'selected' : '';?>
                                            value="API_5">API 5
                                        </option>
                                        <?php endif?>
                                    </select>
                ...
                <section class="col-lg-6 connectedSortable">
                    ...
                    <?php endif?>
                    <?php if(checkAddon(11621) != false && checkAddon(11634) != false && checkAddon(11656) != false && checkAddon(11678) != false && checkAddon(11698) != false):?>
                    <div class="alert alert-warning alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <h5><i class="icon fas fa-exclamation-triangle"></i> Alert!</h5>
