...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Cửa hàng Plugin</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= BASE_URL('admin/'); ?>">Bảng Điều Khiển</a></li>
                        <li class="breadcrumb-item active">Cửa hàng Plugin</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="alert alert-info">
                ...
                <span>Quý khách liên hệ ngay cho Nguyễn Hoàng Phúc thông qua Zalo <a target="_blank" href="https://zalo.me/0814005773">0814005773</a> để được hỗ trợ chi tiết hơn về Plugin.</span>
            </div>
            <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="zoom">
                                ...
                                <?php endif ?>
                                <img class="card-img-top" width="300px" height="250px" src="https://i.imgur.com/WPzesCl.gif" alt="<?= $addon['name']; ?>">
                            </div>
                            <div class="card-body">
